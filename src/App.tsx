      ...
      >
              ...
              <div className="max-w-screen-2xl mx-auto px-6 py-5">
                <div className="flex items-center gap-5">
                  ...
                  <div className="w-28 h-28 shrink-0">
                    <img
                      src="https://res.cloudinary.com/dx6zonqrt/image/upload/v1780579647/logo_c4w83j.png"
                      alt="ABET Logo"
                      className="w-full h-full object-contain"
                      referrerPolicy="no-referrer"
                    />
                  ...
                  <div className="flex flex-col">
                    {/* Registration */}
                    <span className="text-green-700 font-semibold text-sm uppercase tracking-wider mb-2">
                      {t("registration")}
                    </span>

                    {/* Main Heading */}
                    <h1 className="text-[48px] font-extrabold text-[#243F8F] leading-none uppercase">
                      {t("trust_name")}
                    </h1>

                    {/* Tagline */}
                    <span className="text-[20px] font-semibold tracking-[0.35em] text-slate-500 mt-3 uppercase">
                      {t("tagline")}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between min-h-[70px]">
                  ...
                  <nav className="flex items-center gap-10">
                    {[
                      ...
                      { label: t("programmes"), anchor: "#programmes" },
                      { label: t("scholarships"), anchor: "#scholarships" },
                      { label: t("apply"), anchor: "#apply" },
                      { label: t("gallery"), anchor: "#gallery" },
                      ...
                      <Link
                        ...
                        className={`uppercase transition-all border-b-2 py-2 font-bold ${
                          activeAnchor === item.anchor
                            ? "border-accent text-accent"
                            : "border-transparent text-slate-700 hover:border-accent hover:text-accent"
                        }`}
                        style={{
                          fontSize: "18px",
                        }}
                  ...
                  {/* Language Switch */}
                  <div className="flex items-center rounded-full border border-[#243F8F] overflow-hidden">
                    <button
                      onClick={() => i18n.changeLanguage("en")}
                      className={`px-5 py-2 font-semibold transition-all ${
                        i18n.language === "en"
                          ? "bg-[#243F8F] text-white"
                          : "bg-white text-[#243F8F]"
                      }`}
                    >
                      English
                    </button>
        ...
        <div className="lg:hidden flex items-center justify-between py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] text-green-700 font-semibold text-sm uppercase tracking-wider ">
                {t("registration")}
              </p>
              <h2 className="text-sm uppercase font-bold text-[#243F8F] leading-tight">
                {t("trust_name")}
              </h2>
...
<div className="flex justify-center mt-4">
  <div className="flex items-center rounded-full border border-[#243F8F] overflow-hidden">
    ...
    >
      ...
      {/* BODY CONTENT */}
      <main className="flex-grow pt-[72px] md:pt-[225px]">
        <Routes>
          <Route
            path="/apply"
            element={
                ...
                <section id="trustees" className="py-16 md:py-20 bg-white">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                      ...
                      <div className="bg-white rounded-xl border border-slate-100 hover:border-blue-100 hover:shadow-md transition-all duration-300 p-8 text-center flex flex-col items-center">
                        ...
                        <h3 className="text-xl font-bold text-slate-800 uppercase tracking-tight">
                         {t("trustees.hemant.name")}
                        </h3>
                        <span className="text-accent font-extrabold tracking-wider text-xs uppercase my-1">
                          {t("trustees.hemant.role")}
                        </span>
                        <p className="text-xs text-[#1e3a8a] font-bold uppercase tracking-tight">
                          {t("trustees.hemant.designation")}
                        </p>
                  ...
                  Deeply passionate about bridging access barriers to top institutional education for Scheduled Caste students.
                      ...
                      <div className="bg-white rounded-xl border border-slate-100 hover:border-blue-100 hover:shadow-md transition-all duration-300 p-8 text-center flex flex-col items-center">
                        ...
                        <h3 className="text-xl font-bold text-slate-800 uppercase tracking-tight">
                          {t("trustees.dhiraj.name")}
                        </h3>
                        <span className="text-accent font-extrabold tracking-wider text-xs uppercase my-1">
                          {t("trustees.dhiraj.role")}
                        </span>
                        <p className="text-xs text-[#1e3a8a] font-bold uppercase tracking-tight">
                          {t("trustees.dhiraj.designation")}
                        </p>
                        <div className="h-0.5 w-10 bg-slate-200 my-4" />
                        {/* <p className="text-slate-500 text-xs italic leading-relaxed">
                  Steers operational transparency, ensuring maximum resource efficiency for remote educational settlements.
                      ...
                      <div className="bg-white rounded-xl border border-slate-100 hover:border-blue-100 hover:shadow-md transition-all duration-300 p-8 text-center flex flex-col items-center">
                        ...
                        <h3 className="text-xl font-bold text-slate-800 uppercase tracking-tight">
                         {t("trustees.mahender.name")}
                        </h3>
                        <span className="text-accent font-extrabold tracking-wider text-xs uppercase my-1">
                          {t("trustees.mahender.role")}
                        </span>
                        <p className="text-xs text-[#1e3a8a] font-bold uppercase tracking-tight">
                          {t("trustees.mahender.designation")}
                        </p>
                        <div className="h-0.5 w-10 bg-slate-200 my-4" />
                        {/* <p className="text-slate-500 text-xs italic leading-relaxed">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                      ...
                      <div className="bg-white rounded-xl border border-slate-100 p-6 md:p-8 hover:border-blue-200 hover:shadow-md transition-all duration-300 group flex flex-col justify-between">
                        <div>
                          ...
                          <h3 className="text-lg font-bold text-slate-800 mb-3 uppercase tracking-tight">
                            {t("objectives.scholarships.title")}
                          </h3>
                          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
                            {t("objectives.scholarships.description")}
                          </p>
                        </div>
                        <div className="mt-4 pt-4 border-t border-slate-50">
                          <Link
                            to="/apply"
                            className="text-xs font-bold uppercase text-[#1e3a8a] hover:text-accent tracking-wider inline-flex items-center gap-1"
                          >
                           {t("objectives.scholarships.action")}
                      ...
                      <div className="bg-white rounded-xl border border-slate-100 p-6 md:p-8 hover:border-blue-200 hover:shadow-md transition-all duration-300 group flex flex-col justify-between">
                        <div>
                          ...
                          <h3 className="text-lg font-bold text-slate-800 mb-3 uppercase tracking-tight">
                            {t("objectives.digital_learning.title")}
                          </h3>
                          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
                           {t("objectives.digital_learning.description")}
                          </p>
                        </div>
                        <div className="mt-4 pt-4 border-t border-slate-50">
                          <span className="text-[10px] font-black uppercase text-accent tracking-widest">
                            {t("objectives.digital_learning.action")}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl border border-slate-100 p-6 md:p-8 hover:border-blue-200 hover:shadow-md transition-all duration-300 group flex flex-col justify-between">
                        <div>
                          ...
                          <h3 className="text-lg font-bold text-slate-800 mb-3 uppercase tracking-tight">
                            {t("objectives.books.title")}
                          </h3>
                          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
                            {t("objectives.books.description")}
                          </p>
                        </div>
                        <div className="mt-4 pt-4 border-t border-slate-50">
                          <span className="text-[10px] font-black uppercase text-accent tracking-widest">
                            {t("objectives.books.action")}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl border border-slate-100 p-6 md:p-8 hover:border-blue-200 hover:shadow-md transition-all duration-300 group flex flex-col justify-between">
                        <div>
                          ...
                          <h3 className="text-lg font-bold text-slate-800 mb-3 uppercase tracking-tight">
                            {t("objectives.guidance.title")}
                          </h3>
                          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
                            {t("objectives.guidance.description")}
                          </p>
                        </div>
                        <div className="mt-4 pt-4 border-t border-slate-50">
                          <span className="text-[10px] font-black uppercase text-accent tracking-widest">
                            {t("objectives.guidance.action")}
                          </span>
                        </div>
                      </div>
                    </div>
      ...
      <footer
        id="contact"
        className="bg-[#0f172a] text-slate-300 pt-16 md:pt-20 pb-10 border-t border-slate-800"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="sm:col-span-2 lg:col-span-5">
              ...
              <div className="flex items-center gap-3.5 pt-2">
                {Object.keys(SOCIAL_ICONS).map((social) => {
                  ...
                  const IconComponent =
                    SOCIAL_ICONS[social as keyof typeof SOCIAL_ICONS];
            ...
            <div className="sm:col-span-1 lg:col-span-2">
              ...
              <ul className="space-y-3.5 text-xs sm:text-sm text-slate-400">
                ...
                <li>
                  <a
                    href="#programmes"
                    onClick={handleScrollToSection("#programmes")}
                    className="hover:text-accent transition-colors font-medium"
                  >
                   {t("programmes")}
                  </a>
                ...
                <li>
                  <a
                    href="#scholarships"
                    onClick={handleScrollToSection("#scholarships")}
                    className="hover:text-accent transition-colors font-medium"
                  >
                    {t("scholarships")}
                  </a>
                ...
                <li>
                  <a
                    href="#apply"
                    onClick={handleScrollToSection("#apply")}
                    className="hover:text-accent transition-colors font-medium"
                  >
                    {" "}
                    {t("apply")}
            ...
            <div className="sm:col-span-1 lg:col-span-2">
              ...
              <ul className="space-y-3.5 text-xs sm:text-sm text-slate-400">
                ...
                <li>
                  <a
                    href="#objectives"
                    onClick={handleScrollToSection("#objectives")}
          ...
          <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-center items-center gap-4 text-slate-500 text-[10px] sm:text-base text-center md:text-left">
            <p>
              © 2026 Ambedkar Begumpura Education Trust. All Rights Reserved.
            </p>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 sm:p-8 space-y-6">
                <div>
                  <h4 className="text-xs font-black uppercase text-accent tracking-widest mb-2">
                    The Concept of Begumpura
                  </h4>
                  <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                    Begumpura is an architectural utopia coined by Guru Ravidas,
                    depicting a land without distress, sorrow, or
                    discrimination, where everyone is guaranteed equality and
                    dignity. Babasaheb Dr. B.R. Ambedkar spent his entire
                    lifework building constitutional realities of equality,
                    liberty, and social justice. ABET Trust acts on these
                    principles to ensure educational keys are handed straight to
                ...
                <div className="grid sm:grid-cols-2 gap-6 pt-4 border-t border-slate-100">
                  <div>
                    <h5 className="font-extrabold text-[#1e3a8a] text-xs uppercase tracking-wider mb-2">
                      Core Trust Vision
                    </h5>
                    <p className="text-slate-500 text-xs leading-relaxed">
                      To empower every first-generation SC scholar with adequate
                      financial shielding, digital laptops, competitive text
                      kits, and IAS mentorship pipelines.
                    </p>
                  </div>
                  <div>
                    <h5 className="font-extrabold text-[#1e3a8a] text-xs uppercase tracking-wider mb-2">
                ...
                <div className="pt-4 border-t border-slate-100 bg-slate-50 p-4 rounded-lg">
                  ...
                  <p className="text-slate-500 text-[11px] leading-relaxed">
                    ABET is recognized as a fully transparent Trust. 100% of
                    donations are immediately processed and updated with
                    digitized government certificates. Registered under PAN and
                    Section 80G tax exemptions of the Income Tax Act.
                  </p>
                </div>
              </div>
                ...
                {donationSuccess ? (
                  ...
                  <div className="text-center py-6 space-y-4">
                    <div className="w-16 h-16 bg-blue-50 text-[#1e3a8a] rounded-full flex items-center justify-center mx-auto mb-4 border border-blue-100">
                      <CheckCircle
                        size={36}
                        className="fill-blue-50 text-[#1e3a8a]"
                      />
                    </div>
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed max-w-sm mx-auto">
                      Your simulated support of{" "}
                      <strong className="text-slate-900">
                        ₹{customAmount || donationAmount}
                      </strong>{" "}
                      has been registered underneath the{" "}
                    ...
                    <p className="text-[10px] text-slate-400">
                      This is a simulated verification. ABET thanks you for
                      exploring this design prototype with deep care and social
                      pride!
                    </p>
                  ...
                  >
                    ...
                    <div className="p-3 bg-blue-50 border border-blue-100 rounded text-[11px] text-[#1e3a8a] leading-normal flex gap-2">
                      ...
                      />
                      <span>
                        All donations are eligible for 100% Tax Exemption
                        certificate details. (Sec 80G ABET Certificate ID
                        verified).
                      </span>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <option value="Scholarship Fund">
                          Dr. Ambedkar Scholarship Fund (Fees)
                        </option>
                        <option value="Digital Tech Support">
                          Digital Classroom & Computer Drive
                        </option>
                        <option value="Books Distribution">
                          Primary Free Study Books Program
                        </option>
                        <option value="General Support">
                          General Community Upliftment Programs
                        </option>
                      </select>
                    </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 text-xs rounded bg-slate-50 border border-slate-200 outline-none focus:border-accent"
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 text-xs rounded bg-slate-50 border border-slate-200 outline-none focus:border-accent uppercase"
                        ...
                        <div className="bg-slate-50 border border-slate-200 rounded p-2.5 flex items-center justify-center text-center">
                          <div className="text-[10px] text-slate-500 leading-tight">
                            <span className="font-extrabold uppercase text-xs block text-slate-800">
                              State Bank of India
                            </span>
            ...
            >
              ...
              <div className="p-6 space-y-4 text-xs sm:text-sm text-slate-600">
                <p className="leading-relaxed">
                  ...
                  Your educational financial assistance file has been cataloged
                  onto ABET core servers.
                </p>

                <div className="bg-slate-50 rounded pl-4 pr-3 py-3 border-l-4 border-accent space-y-1.5 font-medium text-slate-700">
                  <div className="uppercase text-[9px] font-bold text-slate-400 leading-none mb-1">
                    Board Review Steps:
                  </div>
                  <div>
                    1. Geographic Residential Audit (Delhi Address Check)
                  </div>
                  <div>
                    2. Scheduled Caste validation checking (Certificate check)
                  </div>
                  <div>
                    3. Direct Fund routing determination directly to institution
                  </div>
                </div>

                <div className="bg-slate-50 rounded p-3 text-[10px] text-slate-400 leading-normal">
                  * Please save your reference code{" "}
                  <strong className="text-slate-600">{applicationRef}</strong>{" "}
                  for communication queries with the Settlor Board. A physical
                  confirmation notice is routed to +91 {form.phone}.
                </div>
              </div>
            ...
            >
              ...
              <div className="bg-slate-900 p-4 rounded-lg pointer-events-auto border border-white/5">
                ...
                <div className="flex justify-between items-center text-[10px] text-slate-400 uppercase font-bold tracking-widest mt-2">
                  ...
                  <span>
                    {activeGalleryIndex + 1} of {GALLERY_IMAGES.length}
                  </span>
                </div>
              </div>
            </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 relative z-30 w-full header-content-wrapper">
        <div className="max-w-xl lg:max-w-2xl text-left">
          ...
          <h1 className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-6 tracking-tight">
               {t("hero_title_1")} <br/><span className="text-accent italic font-serif">{t("hero_title_2")}</span> 
            </h1>
          ...
          {/* Styled CTA Button matching the image design */}
           <div className="flex flex-col sm:flex-row gap-4 lg:gap-5 w-full sm:w-auto">
              <Link to="/apply" className="btn-accent px-8 lg:px-10 py-4 lg:py-5 text-center text-base lg:text-lg flex items-center justify-center gap-3 shadow-2xl">
                {t("apply_btn")}<ChevronRight size={20} />
              </Link>
